        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <div className="flex gap-2">
              ...
              <div  className="rounded-full border-2 border-[#9514FA] px-4 py-2 text-lg font-semibold text-white">
                
                  <h1 className="text-2xl  bg-gradient-to-r from-[#4F39F6]  to-[#9514FA] bg-clip-text text-transparent">
                    Watch Demo
                  </h1>
